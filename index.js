...
const gamesDir = 'puzzlescript/packages/puzzlescript/games'
...
game (
    ...
    rom ( name "${gameInfo.slug}.pz" size ${gameInfo.size} crc ${gameInfo.crc32.toUpperCase()} md5 ${gameInfo.md5.toUpperCase()} sha1 ${gameInfo.sha1.toUpperCase()} )
)
`
    }
